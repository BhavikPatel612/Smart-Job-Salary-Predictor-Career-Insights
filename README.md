...
• My task was to develop a salary prediction system that predicts estimated salary based on years of experience.

A – Action

To complete this project, I performed the following steps:

• Used Python and Streamlit to build the application
• Loaded salary dataset using Pandas
• Used Linear Regression machine learning algorithm
• Trained the model using experience and salary data
• Created user input options such as:
• years of experience
• city
• skills
• Used Plotly for interactive salary visualization
• Added scatter plot graph for salary insights
